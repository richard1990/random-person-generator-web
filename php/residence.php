<?php
	...
	if ($country == "Canada") {
		...
		$quebecArr = array("Montreal", "Quebec City", "Laval", "Gatineau", "Longueuil", "Sherbrooke", "Saguenay", "Lvis", "Trois-Rivi?res", "Terrebonne", "Repentigny", "Brossard", "Drummondville", "Saint-J?r?me", "Granby", "Blainville", "Shawinigan", "Dollard-des-Ormeaux");
